...
import { emailRegister, registerSellerDatabase } from "@/firebase/register";
    ...
    emailRegister({ email, password })
      .then((response) => {
        ...
        registerSellerDatabase({
          ...
          .then(() =>
            {
        console.log("Seller collection done")
